...
root.configure(bg='light blue')  # Đặt màu nền của cửa sổ là xanh nhạt
...
# Tạo nút để chạy mã
button_run = tk.Button(root, text="Run Code", command=run_code, bg='light green')  # Đặt màu nền của nút là xanh nhạt
button_run.pack()
